...
VALUES (
    ...
    (
        'charlie',
        '1937e316529d8b6e582d0c4cddb456c3',
        NULL
    ),
    (
        'gestion',
        '3695c56a2c1d477cb1eaad2ccad6dae5',
        'Admin sys'
    ),
    (
        'tec2',
    ...
    (
        'isabel',
        '84bbd073b66596192c110a53f4080cd4',
        NULL
    ),
    ('eric', 'd891893f26b9d3d9bdce7b7e77ea8b3d', NULL),
    (
        'karen',
        'd9355b2e1ad292853bd8e30b30b6a01a',
        NULL
    ),
    (
        'louis',
        'ca9d93cc991648095ab9e08f3fc13b1c',
        NULL
    ),
    (
        'marie',
    ...
    (
        'admin',
        'de5d59d6517cb6d5a8629a7f4e0bafb3',
        'Admin web'
    ),
    ('jack', '54b6c4b298e6696cbd07d30b96c1ae8b', NULL),
    (
        'tec4',
        '35a3a501b25c7f68110f0c5e7b9ecf85',
        'Technicien'
    ),
    (
        'queen',
        'b0c4a64d7f69f1880b44aafc00d4c990',
        NULL
    ),
    (
        'frank',
        'ec83ab13db7c9e6dace9b7c98cc78c66',
        NULL
    ),
    (
        'tec5',
...
VALUES (
    ...
    (
        ...
        4,
        'Fermé',
        'Besoin d\'aide pour une nouvelle fonctionnalité',
        '2023-11-04',
        '192.168.1.15',
        4,
        'diana',
    ...
    (
        ...
        3,
        'En cours de traitement',
        'Problème d\'accès à un dossier partagé',
        '2023-11-05',
        '192.168.1.20',
        3,
        'eric',
    ...
    (
        ...
        4,
        'Ouvert',
        'Demande de formation sur le logiciel Y',
        '2023-11-08',
        '192.168.1.35',
        4,
        'eric',
    ...
    (
        ...
        3,
        'Fermé',
        'Problème de messagerie instantanée',
        '2023-11-09',
        '192.168.1.40',
        3,
        'isabel',
    ...
    (
        ...
        2,
        'Ouvert',
        'Problème d\'imprimante partagée',
        '2023-11-10',
        '192.168.1.45',
        2,
        'jack',
    ...
    (
        ...
        4,
        'Ouvert',
        'Problème avec le téléphone de l\'entreprise',
        '2023-11-16',
        '192.168.1.75',
        4,
        'alice',
    ...
    (
        ...
        2,
        'Fermé',
        'Demande de dépannage informatique',
        '2023-11-18',
        '192.168.1.85',
        2,
        'charlie',
...
INSERT INTO Log_connexion_echec (date, login_tente, mdp_tente, IP)
VALUES (
        '2023-11-01',
        'john_doe',
        '8c32f5a6c9a00a52e6028da4e4b462ed',
        '192.168.1.5'
    ),
    (
        '2023-11-02',
        'user123',
        'e150a7f07c5f81b13e6ba283b2e9c98b',
        '192.168.1.8'
    ),
    (
        '2023-11-03',
        'test_user',
        'ebc3ee94d56b98b99c700f9e1f27c6d6',
        '192.168.1.12'
    ),
    (
        '2023-11-04',
        'john_smith',
        '6a91e1a3d84c9a3e79c4c1d7a0db6c8f',
        '192.168.1.15'
    ),
    (
        '2023-11-05',
    ...
    (
        '2023-11-06',
        'user1',
        '35ee0a6b5f0a2ec5c16b05d6f03f3a16',
        '192.168.1.25'
    ),
    (
        '2023-11-07',
    ...
    (
        '2023-11-08',
        'jane_doe',
        '73e84d81a2f9b79f469c5be4b9b12fcf',
        '192.168.1.35'
    ),
    (
        '2023-11-09',
    ...
    (
        '2023-11-10',
        'johnny',
        '7579c90b3ed1ac328f78b2d3f43047e8',
        '192.168.1.45'
    ),
    (
        '2023-11-11',
        'admin2',
        '6fa92c62d0b944e7895b673eaf9ee7b8',
        '192.168.1.50'
    ),
    (
        '2023-11-12',
    ...
    (
        '2023-11-13',
        'user3',
        '55fc3c66a5f9d7a9519ed9c6f8a04838',
        '192.168.1.60'
    ),
    (
        '2023-11-14',
        'user4',
        '2afcf51289056cda99a8ae2d06feadc4',
        '192.168.1.65'
    ),
    (
        '2023-11-15',
        'user5',
        '4d7fe90d758b103e9df76cc30bfb95cf',
        '192.168.1.70'
    ),
    (
        '2023-11-16',
        'admin3',
        '64b4ba93f4c92e52aa123d6e27d8c946',
        '192.168.1.75'
    ),
    (
        '2023-11-17',
        'test_user2',
        '1db0b0e06eb99e99281ae4e5e6ad6a0d',
        '192.168.1.80'
    ),
    (
        '2023-11-18',
        'guest2',
        '6ba4415b2e7816a3899e6508f76d1bb2',
        '192.168.1.85'
    ),
    (
        '2023-11-19',
