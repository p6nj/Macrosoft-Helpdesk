drop user `admin`@localhost, `alice`@localhost, `charlie`@localhost, `diana`@localhost, `eric`@localhost, `frank`@localhost, `gestion`@localhost, `grace`@localhost, `isabel`@localhost, `jack`@localhost, `karen`@localhost, `louis`@localhost, `marie`@localhost, `queen`@localhost, `tec1`@localhost, `tec2`@localhost, `tec3`@localhost, `tec4`@localhost, `tec5`@localhost, `tec6`@localhost;
